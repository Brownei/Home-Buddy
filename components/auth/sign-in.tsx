      ...
      <div className=" grid gap-6 ">
        <div className="relative flex items-center justify-center rounded-lg">
          <Button
            ...
            size="md"
            className="border border-[#E0E0E0] bg-white hover:bg-white text-[#4F4F4F] font-semibold px-6 flex w-full justify-center items-center text-center gap-4 rounded-lg"
          >
            <span>
              <Image
                className="me-1"
