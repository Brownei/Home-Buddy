...
// export async function GET(req: NextApiRequest, { params }: { params: { reviewId: string } }) {
//     const id = params.reviewId
//     const redisKey = `review-${id}`
//     let result;
...
//         if(!review) {
//             return NextResponse.json({ message: "No such review found!"}, {status: 404})
//         }
//         result = review
